...
echo "Expected value for getDate(): 25-12-2020. Actual value: " . $bookedLesson1->getDate()->format("d-m-Y") . "<br>";
...
echo "Expected value for getDate(): 25-12-2020. Actual value: " . $bookedLesson2->getDate()->format("d-m-Y") . "<br>";
echo "Expected value for getLessonTime():";
var_dump($lessonTimeCorrect);
echo "<br>Actual value: ";
...
echo "Expected value for getDate(): 25-12-2020. Actual value: " . $bookedLesson3->getDate()->format("d-m-Y") . "<br>";
echo "Expected value for getLessonTime():";
var_dump($lessonTimeCorrect);
echo "<br>Actual value: ";
...
echo "Expected value for getDate(): 25-12-2020. Actual value: " . $bookedLesson4->getDate()->format("d-m-Y") . "<br>";
echo "Expected value for getLessonTime():";
var_dump($lessonTimeCorrect);
echo "<br>Actual value: ";
...
echo "Expected value for getDate(): 25-12-2020. Actual value: " . $bookedLesson5->getDate()->format("d-m-Y") . "<br>";
echo "Expected value for getLessonTime():";
var_dump($lessonTimeCorrect);
echo "<br>Actual value: ";
